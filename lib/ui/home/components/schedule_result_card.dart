...
class ScheduleResultCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final lines = schedule // wadah untuk menyimpan schedule
        .split('\n')
        .map((line) => line.trim()) // untuk menyimpan key value
        .where((line) => line.isNotEmpty) // line ini sudah siap untuk menampung result, wadah ini kosong dan siap untuk di isi
        .toList(); 
